...
const MyJobDetails = ({ singleJob, refetch}) => {
    ...
    return (
        <div>
            <div key={singleJob._id} data-aos="flip-left"
                data-aos-easing="ease-out-cubic"
                data-aos-duration="2000" >

                <div className="w-fit h-[405px] bg-green-400 border border-gray-200 rounded-lg shadow-2xl dark:bg-gray-800 dark:border-gray-700 p-5 mb-5">
